    ...
    return (
        <div style={{ textAlign: "left", fontSize: 16 }}>
            <div style={{ margin: 32 }}>
                ...
                -The game will last for 28 days after contract deployment (1/16 11:09 AM EST - 2/13 11:09 AM EST).<br />
                &emsp;-Minting and upgrading are only available during this time period.<br />
                -Once the game ends, 90% of the pot will be redistributed back to the players. In addition, 50% of the Circle Game DAO tokens will go to players upon launch.<br />
                &emsp;-Players will be able to burn their {" "}<span style={{ color: "orange" }}>&#11044;</span>{" "}
                {" "}<span style={{ color: "green" }}>&#11044;</span>{" "}
                {" "}<span style={{ color: "red" }}>&#11044;</span>{" "}
                {" "}<span style={{ color: "blue" }}>&#11044;</span>{" "}
                {" "}<span style={{ color: "purple" }}>&#11044;</span>{" "}
                {" "}<span style={{ color: "pink" }}>&#11044;</span>{" "} to claim the ETH via the Claim tab. DAO tokens will be allocated only to the players that claim.<br />
                ...
                &emsp;-Note that due to increasing mint prices and royalties over time, accumulating circles earlier in the game is more beneficial than later. <br />
